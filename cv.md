...
• Business Development skills - marketing, pre-sale activities, business analysis, proposals, tech interviews, training
...
# Experience:
#
* Independent Consultant == == March 2024 - Now
Edutainment project, currently in stealth mode.

[_JavaScript, Node.js, WebGL_]
#
* DataArt == Solutions Architect == June 2021 - Feb 2024
...
#
* Luxoft == Solutions Architect == Jan 2018 - June 2019
...
# 
* IntroPro == Solutions Architect,|Deputy Director of |Biz Dev Department,|Director of Academy == Oct 2011 - Jan 2018
...
#
# Skills:
* *Languages:* _JavaScript, Java, Scala, Go, Groovy, C, Python_
...
* Hands-on experience with various CI/CD pipelines for microservices, can design and setup a complex pipeline for any deployment scenario with any tools at your disposal - Jenkins, GitHub Actions, BitBucket Pipelines, AWS CodeBuild/CodeDeploy...

* _*Fluent English*_

* _Interested in education, gamification, and the history of technology._
# Education:
